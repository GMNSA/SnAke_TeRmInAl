...
EXECUTABLE=a.out
SOURCES=srcs/main.c srcs/f_log_file.c srcs/snake_game.c srcs/snake_game_menu.c srcs/my_sleep.c srcs/snake_game_processing.c srcs/snake_game_about.c
OBJECTS=$(SOURCES:.c=.o)
LIBC=libs/libinput.a

EXECUTABLE_TEST=test.out
SOURCES_TEST=tests/main.c srcs/f_log_file.c srcs/snake_game.c srcs/snake_game_menu.c srcs/my_sleep.c srcs/snake_game_processing.c srcs/snake_game_about.c
